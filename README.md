...
* **Linux (Debian/Ubuntu):** WebKit2GTK and build essentials:
```bash
...
* **Windows:** Standard C++ build tools and Node/Bun environment.

### Setup & Compilation Steps

1. **Clone the repository:**
```bash
git clone https://github.com/your-username/comiquero.git
cd comiquero
...
The compiled binaries will be output to the `build/` directory matching your platform target.
